...
# Création list des href de livres dans une catégorie
def listes_livres_par_categorie(URL):
    reponse = requests.get(URL)
    soup = BeautifulSoup(reponse.text, 'lxml')
    for i in soup.find_all(class_='image_container'):               #renforcer la sélection avec l'ensemble au-dessus
        sufixe_URL = i.findChild('a').get('href')
